	...
	<div class="card-body">
		...
		<div class="row my-2">
			...
			<div class="col-md-2 col-sm-12">
				<?= form_open('category/search', ['method' => 'POST', 'class' => 'form-inline']) ?>
				<div class="form-group">
					...
					<div class="btn-group mx-sm-3" role="group" aria-label="Basic example">
						...
						<a href="<?= base_url('category/reset') ?>" class="btn btn-sm btn-secondary"><i class="fa fa-fw fa-eraser"></i></a>
					</div>
				</div>
				<?= form_close() ?>
			</div>
					...
					foreach ($content as $row) : $no++; ?>
						<tr>
							...
							<td>
								...
								<a href="<?= base_url("category/edit/$row->id") ?>" class="btn btn-sm"><i class="fas fa-fw fa-edit text-info"></i></a>
