...
class Slider extends MY_Controller
{
	...
	public function index($page = null)
	{
		...
		$data['pagination'] = $this->slider->makePagination(base_url('slider'), 3, $data['total_rows']);
	...
	public function create()
	{
		...
		if (!$this->slider->validate()) {
			...
			$data['input']      = $input;
			$data['form_action'] = base_url('slider/create');
	...
	public function edit($id)
	{
		...
		if (!$this->slider->validate()) {
			...
			$data['form_action'] = base_url("slider/edit/$id");
			$data['page'] = 'pages/admin/slider/form';
