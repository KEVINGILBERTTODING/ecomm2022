					...
					<table class="table table-striped">
						...
						<tbody>
							<?php foreach ($order_paid as $row_paid) : ?>
								<tr>
									<td><a href="<?= base_url("order/detail/$row_paid->id") ?>"><strong>#<?= $row_paid->invoice ?></strong></a></td>
					...
					<table class="table table-striped">
						...
						<tbody>
							<?php foreach ($order_process as $row_process) : ?>
								<tr>
									<td><a href="<?= base_url("order/detail/$row_process->id") ?>"><strong>#<?= $row_process->invoice ?></strong></a></td>
